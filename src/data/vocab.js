...
export const DECKS = [
  ...
  {
    id: "agile",
    title: "Agile & Scrum (Teams)",
    desc: "For international distributed software teams",
    level: "B1",
    cards: [
      { term: "sprint", es: "iteración corta de trabajo", ex: "We plan our work in two-week sprints." },
      { term: "standup", es: "reunión diaria breve", ex: "Let's keep the standup short today." },
      { term: "backlog", es: "lista de tareas pendientes", ex: "That feature is in the backlog." },
      { term: "user story", es: "historia de usuario", ex: "I finished the user story for login." },
      { term: "blocker", es: "impedimento", ex: "My only blocker is the API access." },
      { term: "retrospective", es: "retrospectiva", ex: "In the retrospective we discuss improvements." },
      { term: "stakeholder", es: "parte interesada", ex: "The stakeholder approved the design." },
      { term: "deadline", es: "fecha límite", ex: "We're on track for the deadline." },
      { term: "to assign", es: "asignar", ex: "Can you assign this task to me?" },
      { term: "time zone", es: "zona horaria", ex: "We schedule calls across time zones." },
      { term: "to sync up", es: "ponerse al día / coordinar", ex: "Let's sync up after lunch." },
      { term: "scope", es: "alcance", ex: "That's out of scope for this sprint." },
    ],
  },
  {
    id: "software",
